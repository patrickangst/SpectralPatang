...
interpret_r <- function(r) {
  ...
  # Script: CorrelationTesting_All_Custom.R
  # Description: Tests correlation between custom spectral species indices and ecological metrics using various statistical methods and visualizations.
