...
############################################################
# Script Name:    CreateKmeansOnRawData.R
# Author:         Patrick Byron Angst
# Date Created:   2025-09-30
# Last Modified:  2025-09-30
# Version:        1.0
# Description:    Performs k-means clustering on raw hyperspectral data, including optimal cluster estimation and evaluation of clustering parameters.
#
# Dependencies:   terra, scico
# Input Files:    Data matrices from hyperspectral images
# Output Files:   Cluster assignments, evaluation plots
#
# License:        MIT
############################################################
