...
############################################################
# Script Name:    CreateSingeFiles.R
# Author:         Patrick Byron Angst
# Date Created:   2025-09-30
# Last Modified:  2025-09-30
# Version:        1.0
#
# Description:    This script processes a master ecological community dataset from a
#                 single Excel file. It splits the data by testsite, cleans each
#                 subset by removing empty rows/columns, normalizes species abundance,
#                 and then calculates four key diversity indices (Shannon, Simpson,
#                 Richness, Evenness) for each plot. The final processed data for
#                 each testsite is saved as a separate Excel file.
#
# Dependencies:   vegan, readxl, openxlsx, dplyr
#                 (Note: writexl, NbClust, dbscan, ggplot2, tidyr, and pracma are
#                 loaded but not used).
#
# Input Files:    - A master Excel file containing species abundance data for all sites:
#                   'All_plots_Desktop.xlsx', sheet 'InputPlantCommunity'.
#
# Output Files:   - Creates a 'site_data/' directory.
#                 - Multiple Excel files, one for each testsite (e.g., 'AN_TJ_1.xlsx'),
#                   containing processed data and calculated diversity indices.
#
# License:        MIT
############################################################
